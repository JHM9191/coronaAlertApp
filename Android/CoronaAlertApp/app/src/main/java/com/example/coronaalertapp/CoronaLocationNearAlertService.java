...
public class CoronaLocationNearAlertService extends Service {
    ...
    Location[] locations;
    String result;
    public static ArrayList<CoronaLocationVO> coronaLocations;
    public static ArrayList<CoronaLocationVO> list_loc_enter = new ArrayList<>();
    Vibrator vibrator;
    String state = "NONE";
...
//    }
    ...
    public void onCreate() {
        ...
        Log.d("===", "Started CoronaLocationNearAlertService.java");
        ...
        try {
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                ArrayList<CoronaLocationVO> list_location = new ArrayList<>();
                for (int j = 0; j < ja_location.length(); j++) {
                    ...
                    CoronaLocationVO location = new CoronaLocationVO(no, name_location, lat, lon);
